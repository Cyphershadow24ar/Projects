def hungergames_madlib():
    template = """
    [Number] seconds. That’s how long we’re required to [Verb] on our metal circles before
    the sound of a [Noun] releases us. Step off before the [Number] seconds is up, and [Plural Noun1] blow your
    legs off. [Number] seconds to take in the ring of tributes all equidistant from the [Important Sounding Thing], a giant
    [Adjective] [Noun2] shaped like a [Noun3] with a curved tail, the mouth of which is at least twenty feet
    high, spilling over with the things that will give us life here in the arena. Food, containers of water,
    [Plural Noun2], medicine, garments, [Plural Noun3]. Strewn around the [Important Sounding Thing] are other supplies, their value
