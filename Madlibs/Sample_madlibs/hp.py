def hp_madlib():
    template = """
    A [Adjective1] glow burst suddenly across the enchanted sky above them as an edge of
    dazzling sun appeared over the sill of the nearest [Noun1]. The light hit both of their [Body Part]
    at the same time, so that Voldemort’s was suddenly a flaming [Noun2]. Harry heard the high voice
    shriek as he too [Verb Past] his best hope to the heavens, pointing Draco’s [Noun3]:
    "[Spell1]!"
    "[Spell2]!"
    The bang was like a cannon blast, and the [Adjective2] flames that erupted between them,
    at the dead center of the circle they had been treading, marked the point where the
    [Noun Plural] collided. Harry saw Voldemort’s [Adjective3] jet meet his own spell, saw the Elder Wand
    ...
    of the [Adjective4] [Body Part2] rolling upward. Tom Riddle hit the floor with a mundane finality, his body
    feeble and shrunken, the white hands empty, the snakelike face vacant and unknowing. Voldemort
    was dead, [Verb Past2] by his own rebounding [Noun5], and Harry stood with two wands in his hands,
